...
* *The number of births*
    * This increased from `r fmt(tab$births[tab$decade=="2000s"])` in the 2000s to `r fmt(tab$births[tab$decade=="2010s"])` in the 2010s (+`r fmt(births_increase)`).
    * This was `r percent_increases[1]`% of the total increase from the 2000s to the 2010s.
...
* *The number of children aging out of childhood*
    * This increased from `r fmt(tab$agedout[tab$decade=="2000s"])` in the 2000s to `r fmt(tab$agedout[tab$decade=="2010s"])` in the 2010s (+`r fmt(ageout_increase)`).
    * This was `r percent_increases[2]`% of the total increase from the 2000s to the 2010s.
    * Of the three factors, this was the single biggest contributor to the child population increase. This increase isn't exactly a policy achievement. It's more a statistical artifact that exists because there just weren't that many 5-to-14-year-olds living in DC in 2010, who would age out of childhood by 2020. And that is largely because the 2000s were the nadir of DC's youth-age population. See the appendix for more.

* *Less child net out-migration*
    * This increased from `r fmt(tab$netmig[tab$decade=="2000s"])` in the 2000s to `r fmt(tab$netmig[tab$decade=="2010s"])` in the 2010s (+`r fmt(migrat_increase)`).
    * This was `r percent_increases[3]`% of the total increase from the 2000s to the 2010s.
