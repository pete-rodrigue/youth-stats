...
The chart below shows the number of births in DC over time. The fact that DC's youth-age population has risen, even while the number of births has gone down since 2010 suggests a lot of the growth in the child population is due to people moving here with kids.
...
Demographers calculate the "general fertility rate" by dividing the births by the female population ages 15 to 44, and multiplying by 1,000.^[https://www.ncbi.nlm.nih.gov/books/NBK215693/] The chart below shows DC's GFR over time. This has fallen continuously, which suggests that the increase in births observed above is due to general population increases.
